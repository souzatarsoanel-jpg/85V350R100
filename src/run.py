...
def create_app():
    ...
    if flask_env == 'production' and '*' in cors_origins:
        print("⚠️  AVISO: CORS_ORIGINS deve ser configurado para domínios específicos em produção")
    ...
    if flask_env == 'production':
        ...
        file_handler = RotatingFileHandler('manus_ai.log', maxBytes=10240000, backupCount=10)
        ...
        app.logger.info('Manus AI startup em modo PRODUÇÃO')
